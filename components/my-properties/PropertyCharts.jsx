    ...
    return (
        <div className="flex justify-between">
            <div className="flex flex-col items-center">
                ...
                <h4 className="font-semibold text-center mb-3">Marketing</h4>
                ...
                <div className="flex gap-24 mt-4 text-sm">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium">{marketing}% Completed</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-[#10b981]" />
                        <span className="font-medium">{100 - marketing}% Remaining</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center">
                <div className="items-center">
                <h4 className="font-semibold text-center mb-3">Compliance</h4>
                <div className="w-full flex items-center">
                    <div style={{ width: 220, height: 220 }}>
                        <ResponsiveContainer width="100%" height={220}>
                            <PieChart>
                ...
                <div className="flex gap-24 mt-4 text-sm">
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-[#001f3f]" />
                        <span className="font-medium">{compliance}% Completed</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-[#10b981]" />
                        <span className="font-medium">{100 - compliance}% Remaining</span>
                    </div>
                </div>
            </div>
        </div>
