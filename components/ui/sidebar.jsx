...
function SidebarMenu({ className, ...props }) {
    return (
        <ul
            ...
            data-sidebar="menu"
            className={cn("flex w-full px-2 min-w-0 flex-col gap-2", className)}
            {...props}
        />
    );
}
...
const sidebarMenuButtonVariants = cva(
    "peer/menu-button flex w-full items-center gap-2 overflow-hidden p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
    {
        variants: {
            variant: {
                default:
                    "hover:bg-white/5 hover:border-l-2 hover:border-white hover:text-sidebar-primary-foreground",
                outline:
        ...
        compoundVariants: [
            {
                ...
                // applies to ANY variant & size
                dataActive: true,
                className:
                    "bg-white/5 border-l-2 border-white font-medium text-white",
            },
        ],
    }
);
